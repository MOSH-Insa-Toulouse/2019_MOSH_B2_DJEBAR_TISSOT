...
void initialize_radio()
{
   ...
   */
  const char *devAddr = "26011FE4";
  const char *nwkSKey = "1691F02C77FC5926C3012B6E93615349";
  const char *appSKey = "F25A5F68BF92B3E53E455C18A8864F7E";
   ...
   */
  /*const char *appEui = "70B3D57ED0025CA9";
  const char *appKey = "CF1976248EAF647D4B59AD42D81E0BE7";
...
void loop()
{
    ...
    Serial.print("TXing ");
    Serial.println(a);
    myLora.tx(String(a)); //one byte, blocking function
    //Serial.print("SNR : ");
    //Serial.println(myLora.getSNR());
    //Serial.print("Message: ");
    //String str = myLora.getRx();
    //String decodedStr = myLora.base16decode(str);
